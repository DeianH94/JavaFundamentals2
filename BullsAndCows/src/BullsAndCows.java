...
public class BullsAndCows extends JFrame implements ActionListener {
    ...
    public void createAppForm() {
        ...
        //creat and place guess button on the frame
        ...
        //register this frame as an action listener on both buttons
        ...
        //register 'exit upon closing' ad default close operation
    ...
    private void runGuess(String numString) {
        ...
        if ((guess / 1000) <= 0 || (guess / 1000) >= 10) {
            JOptionPane.showMessageDialog(null,
                    "Please enter in a four-digit number without repeats or 0.");
            numOfGuesses--;
        } else if (guess == number) { //game won
        ...
        } else { // calculate number of bulls and cows
            for (int i = 0; i < 4; i++) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (event.getSource().equals(restart)) {
            ...
            textArea.append(RULES);
        } else { // check which button the action performed is from
